...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths()
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSource('leagues.html'));
        $this->assertEquals("path (final)\n", $loader->getSource('@__main__/leagues.html'));
        $this->assertEquals("named path (final)\n", $loader->getSource('@named/leagues.html'));
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for leagues.html in the named namespace
        $namedSource = $loader->getSource('@named/leagues.html');
        $this->assertEquals("named path\n", $namedSource);

        // get leagues.html from the main namespace
